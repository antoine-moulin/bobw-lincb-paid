...
\begin{enumerate}
    ...
    \db{I guess it's fine to have heteroscedastic noise here, should be fine to keep this.}
\end{enumerate}
%
...
We denote $\cH_t = \sigma \spr*{X_s, A_s, O_s, \scbr*{l_s \spr*{X_s, o}}_{o \in O_s}, s \leq t}$ the filtration generated by all past contexts, actions, and observed losses. We write $\bbP_t = \bbP \sbr*{\cdot \given \cH_{t-1}}$ and $\bbE_t = \bbE \sbr*{\cdot \given \cH_{t-1}}$. Finally, we use equivalently the notation $a = \cO \spr*{b}$ or $a \lesssim b$ when there exists a constant $\omega > 0$ such that $a \leq \omega b$, where $\omega$ is independent of the following problem-dependent quantities: $T, d, K, \Sigma, \cD, C, \deltamin$.