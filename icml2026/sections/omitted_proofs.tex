...
\begin{align*}
    ...
    &= \frac{1}{1 - \alpha} \sumaK \spr*{q_a - q_a' - q_a^\alpha + \spr*{q_a'}^\alpha + \spr*{\alpha \spr*{q_a'}^{\alpha - 1} - 1} \spr*{q_a - q_a'}}\\
    &= \frac{1}{1 - \alpha} \sumaK \spr*{\spr*{q_a'}^\alpha - q_a^\alpha + \alpha \spr*{q_a'}^{\alpha - 1} \spr*{q_a - q_a'}}.
\end{align*}
...
%
\begin{align*}
    \abs{\eta_t \inp{x, \wt \theta_{t, a}}} &\leq
\end{align*}
