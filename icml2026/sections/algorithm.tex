...
\begin{itemize}
    ...
    %
    \begin{equation*}
        \psi_t \spr*{q} \coloneqq - \frac{H_\alpha \spr*{q}}{\eta_t}, \text{ for } H_{\alpha} \spr*{q} \coloneqq \textcolor{red}{\frac{1}{\alpha}} \sum_{a=1}^{K} \spr*{q_a^\alpha - q_a},
    \end{equation*}
    %
...
\db{Remove this discussion at some point}
